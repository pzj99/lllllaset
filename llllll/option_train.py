...
parser.add_argument('--data_path_train', default='/mnt/sda/pzj/data/pancollection/training_wv3/train_wv3.h5',
                    type=str, help='path of train_data')

parser.add_argument("--data_path_test", default='/mnt/sda/pzj/data/pancollection/training_wv3/valid_wv3.h5',
...
parser.add_argument('--outf', type=str, default='/mnt/sda/pzj/exp/fusion/wv_dynamic_b_s/', help='saving_path')
